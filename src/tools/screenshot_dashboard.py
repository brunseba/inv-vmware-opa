...
def main():
    ...
    parser.add_argument("--url", default="http://localhost:8501", help="Dashboard URL (default: http://localhost:8501)")
    parser.add_argument(
        "--output", default="docs/images/screenshots", help="Output directory (default: docs/images/screenshots)"
    )
    parser.add_argument("--headless", action="store_true", default=True, help="Run in headless mode (default: True)")
    parser.add_argument("--page", help="Specific page to capture (default: all pages)")
    parser.add_argument(
        "--theme", choices=["light", "dark", "both"], default="both", help="Theme to capture (default: both)"
    )
    ...
    screenshotter = DashboardScreenshotter(base_url=args.url, output_dir=Path(args.output), headless=args.headless)
