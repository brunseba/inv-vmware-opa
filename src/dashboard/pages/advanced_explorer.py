...
def render(db_url: str):
    ...
    **Advanced Features:**
    ...
    # SQL Query Interface
    colored_header(label="SQL Query", description="Write your custom query below", color_name="violet-70")
    ...
    with st.spinner("Executing query..."):
        try:
            ...
            try:
                ...
                pyg.walk(df, env="Streamlit", spec="./configs/advanced_explorer.json", use_kernel_calc=True, dark=theme)
            except ImportError:
                st.warning(
                    """
