...
def render(_db_url: str):
    ...
    # Dashboard sections
    colored_header(label="📊 Dashboard Pages", description="", color_name="green-70")
    ...
    # Data Model
    colored_header(
        label="🗄️ Data Model & Schema", description="Database structure and relationships", color_name="violet-70"
    )
    ...
    # Export features
    colored_header(label="📄 Export & Reporting", description="", color_name="orange-70")
    ...
    # Keyboard shortcuts
    colored_header(label="⌨️ Keyboard Shortcuts & Interface Tips", description="", color_name="violet-70")
