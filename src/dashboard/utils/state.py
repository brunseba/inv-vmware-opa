...
class StateManager:
    ...
    def get_state_summary() -> dict:
        ...
        """
        return {
            "initialized_keys": [key.value for key in SessionKeys if key.value in st.session_state],
...
class PageNavigator:
    ...
    def is_valid_page(page_name: str) -> bool:
        ...
        """
        all_pages = [page for pages in PageNavigator.PAGES.values() for page in pages]
