...
class ErrorHandler:
    ...
    @staticmethod
    def show_error(error: Exception, show_details: bool = True, context: str | None = None):
...
class DataValidator:
    ...
    @staticmethod
    def validate_string_length(value: str, max_length: int, field_name: str = "Field") -> tuple[bool, str]:
    ...
    def validate_number_range(
        value: float, min_val: float, max_val: float, field_name: str = "Value"
    ) -> tuple[bool, str]:
    ...
    def validate_choice(value: str, choices: list, field_name: str = "Value") -> tuple[bool, str]:
        ...
        Example:
            is_valid, error = DataValidator.validate_choice(state, ["poweredOn", "poweredOf"], "Power State")
        """
